...
module.exports = function(execute) {
	...
	return {
		...
		/*
		 * Experimental API which will search by phone and countryCode on the person.json endpoint
		 * Use the ISO-3166 two-digit country code (Great Britain = GB) or explicitly default to US 
		 */
		...
		/*
		 * Experimental API which will queue the phone for search later.
		 * Return will be a json response, always 202
		 */
